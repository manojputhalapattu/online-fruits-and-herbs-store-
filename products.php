...
<html>
    <head>
        ...
        <title>herbs and fruit shop</title>
        <meta charset="UTF-8">
    ...
    <body>
<div id="fruits"><button onclick="location.href='fruits1.php'">FRUITS</button></div>
<div id="fruits2"><button onclick="location.href='herbs1.php'">HERBS</button>
</div>
<h5>use these buttons for detailed view</h5> 
        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to healthy herbs and fruits Store!</h1>
                    <p>Take care of your health with healthy products </p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product1.jpeg" alt="aloe">
                            </a>
                            <center>
                                <div class="caption">
<h1>ALOE </h1>

                                    <h4>External burns, bites, cuts, or scrapes</h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product2.jpg" alt="pepper mint">
                            </a>
                            <center>
                                <div class="caption">
                                    <h1>PEPPER MINT </h1>
<h4>good for wheezing, sinusitis, asthma and laryngitis</h4>
                                    <p>Price: Rs. 40.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product3.jpg" alt="WITCH HAZEL">
                            </a>
                            <center>
                                <div class="caption">
                                    <h1>WITCH HAZEL</h1>
<h4>bruises, pimples, haemorrhoids ,ease swollen tired eyes.</h4>
                                    <p>Price: Rs. 50.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product4.jpeg" alt="ROSEMARY">
                            </a>
                            <center>
                                <div class="caption">
                                    <h1>ROSE MARY</h1>
<h4> helps in protien balancing and reduces stress</h4>
                                    <p>Price: Rs. 800.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product5.jpeg" alt="apple">
                            </a>
                            <center>
                                <div class="caption">
                                    <h2>APPLE</h2>
<h4>helps in regulating sugar levels</h4>
                                    <p>Price: Rs. 130.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product7.jpeg" alt="PAPAYA">
                            </a>
                            <center>
                                <div class="caption">
                                    <h2>PAPAYA</h2>
<h4>good for colestraol</h4>
                                    <p>Price: Rs. 300.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product8.jpeg" alt="berries">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>CRAN BERRIES</h3>
<h4>prevents urinary infections</h4>
                                    <p>Price: Rs. 80.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product9.jpeg" alt="Favre Leuba">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>PEARS</h3>
<h4>good fo heart diseases</h4>
                                    <p>Price: Rs. 180.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product10.jpeg" alt="carrot">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>CARROT</h3>
<h4>good for eye sight</h4>
                                    <p>Price: Rs. 15.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product11.jpeg" alt="broccoli">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>BROCCOLI</h3>
<h4>good for respiration and heart</h4>
                                    <p>Price: Rs. 100.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product12.jpeg" alt="RADDISH">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RADDISH</h3>
<h4>good for bones and muscles cure fever</h4>
                                    <p>Price: Rs. 90.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product13.jpeg" alt="brinjal">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>BRINJAL</h3>
<h4>good for pain reduction</h4>
                                    <p>Price: Rs. 12.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php

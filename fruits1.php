...
<html>
    <head>
        ...
        <title>fruit and herb shop</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>select your fruit for cure </h1>
                    <p>all kinds of fruits available  </p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fruti1.jpeg" alt="BANANA">
                            </a>
                            <center>
                                <div class="caption">
<h1>BANANA</h1>

                                    <h4>bone strength and muscle growth</h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fruti2.jpeg" alt="GRAPES">
                            </a>
                            <center>
                                <div class="caption">
                                    <h1>GRAPES</h1>
<h4>good for lungs and blood</h4>
                                    <p>Price: Rs. 40.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fruti3.jpg" alt="JACK FRUIT">
                            </a>
                            <center>
                                <div class="caption">
                                    <h1>JACK FRUIT</h1>
<h4>fever reduction &decrease vomtings </h4>
                                    <p>Price: Rs. 50.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fruti4.jpeg" alt="AVACADO">
                            </a>
                            <center>
                                <div class="caption">
                                    <h1>AVACADO</h1>
<h4> helps in decrease weight and reduces stress</h4>
                                    <p>Price: Rs. 800.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
...
<h4>prevents urinary infections</h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fruti5.jpeg" alt="DATES">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>DATES</h3>
<h4>good fo heart diseases</h4>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fruti6.jpeg" alt="carrot">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>CARROT</h3>
<h4>good for eye sight</h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fruti7.jpeg" alt="broccoli">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>BROCCOLI</h3>
<h4>good for respiration and heart</h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fruti8.jpeg" alt="RADDISH">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RADDISH</h3>
<h4>good for bones and muscles cure fever</h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/product9.jpeg" alt="brinjal">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>PEARS</h3>

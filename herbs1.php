...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>purchase your herbs for disease</h1>
                    <p>choose your correct herb for your disease </p>
                </div>
            </div>
            <div class="container">
                <div class="row">
...
<h4> helps in protien balancing and reduces stress</h4>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/herb1.jpg" alt="basil">
                            </a>
                            <center>
                                <div class="caption">
                                    <h2>BASIL</h2>
<h4>helps in fever reduction</h4>
                                    <p>Price: Rs. 130.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/herb2.jpeg" alt="PARSLEY">
                            </a>
                            <center>
                                <div class="caption">
                                    <h2>PARSLEY</h2>
<h4>resloves digestion issues</h4>
                                    <p>Price: Rs. 300.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/herb3.jpeg" alt="chives">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>CHIVES</h3>
<h4>increases body growth</h4>
                                    <p>Price: Rs. 80.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/herb4.jpeg" alt="oregano">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>OREGANO</h3>
<h4>nutrients potential health benifits</h4>
                                    <p>Price: Rs. 180.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/herb5.jpeg" alt="cilantro">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>CILANTRO</h3>
<h4>increases eye sight</h4>
                                    <p>Price: Rs. 15.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/herb6.jpeg" alt="SAGE">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>SAGE</h3>
<h4>good for respiration and heart</h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/herb7.jpeg" alt="DILL">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>DILL</h3>
<h4>good for bones,insomnia&respiratory issues</h4>
                                    <p>Price: Rs. 90.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/herb8.jpeg" alt="thyme">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>THYME</h3>
